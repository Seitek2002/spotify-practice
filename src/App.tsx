                        ...
                        <Flex className="player" justify="space-around" align="center">
                            <div style={{ flex: '1' }}>
                                <Flex justify="center" style={{ gap: '22px' }}>
                                    ...
                                    />
                                    <PlayCircleFilled style={{ color: '#fff', fontSize: '32px', cursor: 'pointer' }} />
                                    <StepForwardFilled
                                        style={{ color: '#d1d1d1', fontSize: '32px', cursor: 'pointer' }}
                                    />
                                    <RedoOutlined style={{ color: '#bababa', fontSize: '20px', cursor: 'pointer' }} />
                                </Flex>
                                <Flex justify="center" align="center" style={{ gap: '8px' }}>
                                    ...
                                    />
                                    <Typography.Text style={{ color: '#fff' }}>4:22</Typography.Text>
                                </Flex>
                            </div>
                            <Flex style={{ gap: '8px' }}>
                                <svg
